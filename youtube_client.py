...
class YouTubeClient(object):
    ...
    def get_playlists(self):
        ...
        # Convert the playlists into a list of Playlist objects
    ...
    def get_videos_from_playlists(self, playlist_id):
        songs = []
        # Fetch video details from the specified playlist
        ...
        # For each video, extract the artist and track name, and add to the list
    ...
    def get_artist_and_track_from_video(self, video_id):
        # Extract artist and track details from a given YouTube video ID
